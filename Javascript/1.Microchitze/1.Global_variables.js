...
var QuizNumbers = new Array();// the numbers associated with quizzes
var QuizTitle = new Array(); // the quiz title in various languages ( 0 = ro; 1 = en; 2 = de )
var IndexList = new Array(); // the IndexList (question indices)
var QList = new Array(); // the QuestionList
var AType = new Array(); // the AnswerTypeList
var AList = new Array(); // the AnswerList with user answers
var CList = new Array(); // the AnswerList with correct answers in plaintext
var EList = new Array(); // the ExplanationList
var RList = new Array(); // the ReferencesList
var HList = new Array(); // the HintList
var IList 	 = new Array(); // the ImageList when showing the question
var IListSrc = new Array(); // the ImageList sources  for the question images
var JList 	 = new Array(); // the ImageList when showing the answer
var JListSrc = new Array(); // the ImageList sources  for the answer images
...
var dbQList  = new Array(); 	// database questions
var dbAType  = new Array();		// database answer types (0 = no input accepted; 1 = free text; 2 = numeric)
var dbAList  = new Array(); 	// database answer part to be checked
var dbACrit  = new Array(); 	// database check criterion for answers (see 2.Database.js head comment)
var dbAnswer = new Array();		// database correct answers in plaintext
var dbExpln  = new Array(); 	// database explanations    associated with each answer
var dbRefer  = new Array();		// database references      associated with each answer/explanation
var dbQHint  = new Array();		// database question remark  displayed with each question
var dbQImage 	= new Array(); 	// database question images associated with each question
var dbQImageSrc = new Array(); 	// database internet source associated with each question image
var dbAImage 	= new Array(); 	// database answer   images associated with each answer
var dbAImageSrc = new Array(); 	// database internet source associated with each answer   image

// TEST DEFINITIONS:

function initIndexList()
{
	//keep all available cases in variable QuizNumbers, to be used by "Prev" and "Next" arrows
	QuizNumbers = [1,2,3,4,5,10,11,12,13,14,15,16,17,18];
	
	switch(auxparam)
	{
		case 01: IndexList = [100,101,102,103,104,105,106,107,108,109]; 
					QuizTitle[0] = "Minimix1: ADEV&#x102;RAT sau FALS";
					QuizTitle[1] = "Minimix1: TRUE or FALSE";
					QuizTitle[2] = "Minimix1: WAHR oder FALSCH";
					break;
		case 02: IndexList = [110,111,112,113,114,115,116,117,118,119];
					QuizTitle[0] = "Minimix2: Siruri";
					QuizTitle[1] = "Minimix2: Sequences";
					QuizTitle[2] = "Minimix2: Reihen";
					break;
		case 03: IndexList = [120,129,121,122,124,123,125,126,127,128];
					QuizTitle[0] = "Minimix3";
					QuizTitle[1] = "Minimix3";
					QuizTitle[2] = "Minimix3";
					break;
		case 04: IndexList = [130,131,132,133,134,135,136,137,138,139]; 
					QuizTitle[0] = "Minimix4";
					QuizTitle[1] = "Minimix4";
					QuizTitle[2] = "Minimix4";
					break;
		case 05: IndexList = [140,141,142,143,144,145,146,147,148,149];

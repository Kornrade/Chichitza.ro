...
AppExplArray[ 3] = new Array();
AppExplArray[ 3][0] = 'Rearanja&#x21B;i piesele astfel &#xEE;nc&#xE2;t &#xEE;n tabel s&#x103; scrie:<br/> <img src="Javascript/3.Interactive/plop.png">';
AppExplArray[ 3][1] = 'Rearrange the tiles so that the table reads: <br/> <img src="Javascript/3.Interactive/plop.png"><br/><br/><i>The Romanian phrase <br/><q>Cand o face plopu\' mere...</q><br/> is equivalent to the English<br/><q>When Hell freezes over...</q></i>';
AppExplArray[ 3][2] = 'Ordnen Sie die Teile so dass die Tabelle lautet: <br/> <img src="Javascript/3.Interactive/plop.png"><br/><br/><i>Der Rum&#228;nische Ausdruck <br/><q>Cand o face plopu\' mere...</q><br/> bedeutet in etwa<br/><q>Wenn es schwarz schneit...</q></i>';
AppExplArray[ 4] = new Array();

...
var dbReadable  = new Array(); 	// database words in readable format (no special characters), arranged alphabetically
var dbWordList  = new Array(); 	// database words, arranged alphabetically
var dbDefList  = new Array(); 	// database definitions corresponding with the above
